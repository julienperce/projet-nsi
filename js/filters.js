function grayscale() {
    ...
    const originalPxData = imgData.data;
        function editImg() {
        for (var x = 0; x < length; x+=4) {
            var r  = originalPxData[x], // These search for the r g b values of a pixel 
                g = originalPxData[x + 1], // r is the 1st value of pixel1, g is the 2nd value of pixel1...
                b = originalPxData[x + 2];
